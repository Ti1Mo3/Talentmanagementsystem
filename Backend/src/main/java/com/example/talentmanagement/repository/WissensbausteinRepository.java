...
public interface WissensbausteinRepository extends JpaRepository<Wissensbaustein, Long> {
    ...
    boolean existsByWissensbereich_Id(Long wissensbereichId);
    boolean existsByNameAndWissensbereich_NameAndWissensbereich_Wissensgebiet_Id(String name, String wissensbereichName, Long wissensgebietId);
}
